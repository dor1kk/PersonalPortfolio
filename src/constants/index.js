...
import MernStack from '../assets/2.png'
import UiDesign from '../assets/3.png'
import Database from '../assets/4.png'
...
export const MySkills = [
    { icon: FullStack, name: 'Full Stack', color: '#f3bc3e', percentage: 90 },
    { icon: MernStack, name: 'Mern Stack', color: '#acace3', percentage: 80 },
    { icon: UiDesign, name: 'UI/UX Design', color: '#94cb9d', percentage: 75 },
    { icon: Database, name: 'Database Management', color: '#f5bcbc', percentage: 75 },
  ];
...
export const MySkillSet = [
    ...
    { icon: "https://images.g2crowd.com/uploads/product/image/social_landscape/social_landscape_96102ac6497377cd53da621075fe828e/sanity.png", name: 'Sanity', color: '#f5bcbc' },
